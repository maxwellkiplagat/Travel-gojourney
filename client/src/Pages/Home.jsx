...
import { MapPin, Heart, Compass, Search } from 'lucide-react';
...
const Home = () => {
  ...
  const handleSearch = (e) => {
    e.preventDefault();
    // Optional: scroll down to trips section
  ...
  {/* 📌 Trip Cards Section */}
  <div id="trips-section" className="max-w-6xl mx-auto px-4 py-12">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
      {filteredTrips.length > 0 ? (
        filteredTrips.map((trip) => (
          <div
            key={trip.id}
            className="bg-white rounded-lg shadow hover:shadow-md transition duration-200 overflow-hidden relative"
          >
